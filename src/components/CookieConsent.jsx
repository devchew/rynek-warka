			...
			<div className="flex flex-col sm:flex-row items-center justify-between gap-4">
				<div className="flex-1">
					...
					<p className="mt-1 text-sm text-stone-600">
						Nasza strona używa plików cookies do poprawy doświadczenia
						użytkownika. Korzystając z tej strony wyrażasz zgodę na używanie
						przez nas plików cookies zgodnie z polityką prywatności.
					</p>
				</div>
				<div className="flex gap-3 shrink-0">
					...
					<button
						...
						className="px-4 py-2 text-sm font-medium bg-amber-800 text-white rounded-md hover:bg-amber-700 transition-colors shadow-sm"
					>
						Akceptuję
					</button>
				</div>
