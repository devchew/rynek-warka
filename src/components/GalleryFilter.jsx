    ...
    <>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        {filteredItems.map((item, index) => (
          <div key={index} className="group rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-shadow">
            ...
            <div className="p-4 bg-white">
              <h3 className="font-serif text-lg font-semibold text-stone-800 mb-2">{item.title}</h3>
